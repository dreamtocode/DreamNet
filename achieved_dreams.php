    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="http://localhost/dreamnet/achieved_dreams.php">Achieved Dreams</a></li>
            </ul>
...
<div class="container">
    ...
    <div class="accordion">
        <dl>
            ...
            $upcoming_dreams = $connection->server->query("SELECT a.user_displayname, b.dream_title, b.dream_text, b.mih_count, b.status FROM users a, dreams b WHERE a.id = b.user_id AND b.status = 'upcoming' AND status = 'achieved'");
