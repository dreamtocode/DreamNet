    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="http://localhost/dreamnet/top_dreams.php">Top Dreams</a></li>
                <li><a href="http://localhost/dreamnet/index.php">Upcoming Dreams</a></li>
...
<div class="container">
    <h1 class="heading-primary">Top supported dreams</h1>
    <div class="accordion">
        <dl>

            <?php

            $upcoming_dreams = $connection->server->query("SELECT a.user_displayname, b.dream_title, b.dream_text, b.mih_count, b.status FROM users a, dreams b WHERE a.id = b.user_id AND b.status = 'upcoming' ORDER BY b.mih_count");
